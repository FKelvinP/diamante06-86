...
const services = [
  {
    ...
    features: [
      'Lavagem externa completa com shampoo premium',
      'Secagem com toalha de microfibra',
      'Limpeza e brilho dos pneus e rodas',
      'Aspiração básica do interior',
  ...
  },
  {
    ...
    features: [
      'Lavagem externa premium com cera líquida',
      'Limpeza interna completa (bancos, painel, portas)',
      'Aspiração profunda de carpetes e estofados',
      'Hidratação e proteção do painel',
      'Limpeza interna e externa dos vidros',
      'Aromatização do interior'
    ],
    details: [
  ...
  },
  {
    ...
    features: [
      ...
      'Proteção UV avançada (até 3 meses)',
      'Brilho espelhado duradouro',
      'Repelência à água e sujeira',
      'Proteção contra oxidação'
    ],
    details: [
      'Cera de carnaúba importada',
      'Proteção de 3 meses',
      'Brilho profissional'
    ],
    popular: false,
  },
  {
    ...
    features: [
      'Descontaminação química da tinta',
      'Polimento profissional em 3 etapas',
      'Enceramento premium com selante',
      'Detalhamento interno completo',
      'Tratamento e brilho dos pneus',
      'Limpeza do motor (externa)',
      'Garantia de qualidade de 30 dias'
    ],
    details: [
      'Produtos profissionais importados',
      'Técnicas avançadas de polimento',
      'Garantia de 30 dias'
    ],
    popular: false,
  },
            ...
            return (
              <Card 
                ...
                className={`relative overflow-hidden transition-all duration-300 hover:shadow-card hover:scale-105 ${
                  service.popular ? 'ring-2 ring-primary shadow-elegant' : ''
                }`}
              >
                {/* Service Image */}
                <div className="relative h-48 overflow-hidden">
                  ...
                  {service.popular && (
                    <Badge className="absolute top-4 right-4 bg-gradient-primary text-primary-foreground flex items-center gap-1">
