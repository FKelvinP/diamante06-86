...
import { Shield, Award, Clock, Users, CheckCircle, Star, ThumbsUp, Trophy, Zap } from 'lucide-react';
...
const ResultsShowcase = () => {
  ...
  return <section id="results-showcase" className="py-20 bg-secondary/30">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-foreground mb-6">
            Veja a{' '}
            <span className="bg-gradient-primary bg-clip-text text-[#cf9b29]/[0.94]">
              transformação
            </span>{' '}
            do seu veículo
          </h2>
        ...
        <div className="mb-16">
          <Card className="overflow-hidden">
            <div className="relative h-64 md:h-96">
              <img src={beforeAfterImg} alt="Comparação antes e depois do serviço de detalhamento" className="w-full h-full object-cover" />
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center text-white">
                  <h3 className="text-2xl md:text-4xl mb-4 text-[#168bed] font-bold">
                    Resultados Profissionais
                  </h3>
                  <p className="text-lg opacity-90 mb-6 md:text-[f6c00c] text-[#efa112] font-medium">
                ...
                }} className="text-[#eb9c14] font-semibold">
                    Agendar Meu Serviço
                  </Button>
                </div>
              </div>
        ...
        <div>
          <div className="text-center mb-12">
            <h3 className="text-2xl md:text-3xl font-bold mb-4 text-[#f6c00c]">
              Nossas Garantias
            </h3>
            <p className="text-lg font-medium text-[#f6c00c]">
              Trabalhamos com total transparência e compromisso com a qualidade
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {guarantees.map((guarantee, index) => <Card key={index} className="text-center hover:shadow-card transition-all duration-300 border-2 hover:border-primary/20">
                <CardContent className="p-6">
                  <div className="flex justify-center mb-4">
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-hero rounded-2xl p-8 max-w-4xl mx-auto text-primary-foreground">
            <div className="flex justify-center mb-4">
              <div className="p-3 bg-white/20 rounded-full">
                <CheckCircle className="h-8 w-8 bg-[f6c00c] bg-transparent" />
              </div>
            </div>
            <h3 className="text-2xl md:text-3xl font-bold mb-4">
              Pronto para transformar seu veículo?
            </h3>
            <p className="mb-6 opacity-90 text-[f6c00c] text-[#f9c30e]">
          ...
          }} className="bg-white hover:bg-white/90 text-[#f6c00c]">
              Agendar Agora
            </Button>
          </div>
        </div>
